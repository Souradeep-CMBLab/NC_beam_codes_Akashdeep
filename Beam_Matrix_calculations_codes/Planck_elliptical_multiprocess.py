"""
This code is originally Developed by Shambhavi Jaiswal (https://github.com/sjaiswal711). This is a modified version for our used case
"""
import numpy as np
import healpy as hp
...
chunk_id=int(sys.argv[1])#0+mpi_id*16+rank
if chunk_id==0:
